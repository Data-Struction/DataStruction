...
def add(name, born_place, born_date, dead_date, height, edu_bg, pos, top_pos, born_rela, rela_ship, sex): #将新增的信息存入list中，但还没有存入txt文件中

    #     print("->已选择 增加成员记录")
#     name = input("请输入姓名：")
#     born_place = input("请输入出生地：")
#     born_date = input("请输入出生日期：")
#     dead_date = input("若已过世请输入死亡日期，否则输入“0”：")
#     height = input("请输入身高：")
